...
var CanvasComponent = /** @class */ (function () {
    ...
    /*//////////////////////no need*/
    CanvasComponent.prototype.showPos = function (ev) {
    ...
    */
    ...
    CanvasComponent.prototype.save = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var workflowName, name_1, workflow;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.authService.saveWorkflow(workflow).subscribe(function (data) {
...
var InputBoxComponent = /** @class */ (function () {
     ...
     */
    InputBoxComponent.prototype.moveConnectors2 = function () {
        var _this = this;
        ...
        var _loop_4 = function (i) {
            var lineId = lines[0];
            var line = this_2.connectors.find(function (j) { return j.id === lineId; });
            // get other connected node
            var node = (line.node1 === this_2.cid) ? line.node2 : line.node1;
            // remove line from other node
            var n1Connectors = this_2.compList.find(function (k) { return k.id === node; }).connectors;
            var n1LineIndex = n1Connectors.indexOf(lineId);
            if (n1LineIndex !== -1) {
                n1Connectors.splice(n1LineIndex, 1);
            }
            // remove line from connectors
            var removeId = this_2.connectors.indexOf(line);
            if (removeId !== -1) {
                this_2.connectors.splice(removeId, 1);
            }
            // remove line from current node
            this_2.compList.find(function (p) { return p.id === _this.cid; }).connectors.splice(0, 1);
        ...
        var neighbors = this.compList.find(function (i) { return i.id === _this.cid; }).neighbors;
        // draw line to each neighbor
        for (var _i = 0, neighbors_1 = neighbors; _i < neighbors_1.length; _i++) {
            var element = neighbors_1[_i];
            this.drawLine(this.cid, element, false, '1');
        }
    };
    /*-----------no need----------------------*/
    InputBoxComponent.prototype.moveConnectors3 = function () {
        var _this = this;
        var connections = this.compList.find(function (i) { return i.id === _this.cid; }).connectors;
        var _loop_5 = function (entry) {
            // finding nodes
            var connectedNode = void 0;
            var leftNode;
            var rightNode;
            if (this_3.cid === this_3.connectors.find(function (i) { return i.id === entry; }).node1) {
                connectedNode = this_3.connectors.find(function (i) { return i.id === entry; }).node2;
            }
            else {
                connectedNode = this_3.connectors.find(function (i) { return i.id === entry; }).node1;
            }
            // getting left and right nodes
            if (document.getElementById(this_3.cid).getBoundingClientRect().left < document.getElementById(connectedNode).getBoundingClientRect().left) {
                leftNode = this_3.cid;
                rightNode = connectedNode;
            }
            else {
                leftNode = connectedNode;
                rightNode = this_3.cid;
            }
            ...
            var leftNodeElm = this_3.compList.find(function (i) { return i.id === leftNode; });
            var rightNodeElm = this_3.compList.find(function (i) { return i.id === rightNode; });
            var lineLeftX = leftNodeElm.x;
            /*+ (leftNodeElm.width / 2);*/
            var lineLeftY = document.getElementById(leftNode).getBoundingClientRect().bottom - leftNodeElm.height;
            var lineRightX = rightNodeElm.x;
            /* + (rightNodeElm.width / 2);*/
            var lineRightY = document.getElementById(rightNode).getBoundingClientRect().bottom - rightNodeElm.height;
            var xDist = lineRightX - lineLeftX;
            var yDist = lineRightY - lineLeftY;
            var hypo = Math.sqrt((Math.pow(xDist, 2) + Math.pow(yDist, 2)));
            var angleRad = Math.atan(yDist / xDist);
            ...
            var adjustment = angleDeg * 3;
            // setting line left position
            var scroll_2 = this_3.getScroll();
            var workspaceX = document.getElementById('workspace').getBoundingClientRect().left;
            var workspaceY = document.getElementById('workspace').getBoundingClientRect().top;
            var paletteX = document.getElementById('palette').offsetLeft;
            var paletteY = document.getElementById('palette').offsetTop;
            var line = document.getElementById(entry);
            console.log('line id: ' + entry);
            var lineLeft = lineLeftX + scroll_2[0] - workspaceX - Math.abs(adjustment) - (paletteX * 3);
            var lineTop = lineLeftY + scroll_2[1] - workspaceY + adjustment - paletteY;
        ...
        for (var _i = 0, connections_1 = connections; _i < connections_1.length; _i++) {
            var entry = connections_1[_i];
            _loop_5(entry);
        }
        console.log('-----------------------------------------------');
    };
    /*-----------no need -------------------*/
    InputBoxComponent.prototype.showpos = function () {
        // alert(this.cid);
...
var InputCircleComponent = /** @class */ (function () {
    ...
    InputCircleComponent.prototype.show = function () {
        alert('see console');
...
module.exports = "<div class=\"line\" id={{cid}} (click)=\"delete()\">\r\n</div>\r\n<!--<svg>\r\n  <line [attr.x1]=x1 [attr.y1]=y1 [attr.x2]=x2 [attr.y2]=y2 style=\"stroke:rgb(255,0,0);stroke-width:5; position: relative\" id={{cid}} (click)=\"my()\"></line>\r\n</svg>-->\r\n<!--<svg height=\"210\" width=\"500\">\r\n  <line x1=\"0\" y1=\"0\" x2=\"200\" y2=\"200\" style=\"stroke:rgb(255,0,0);stroke-width:10\" (click)=\"my()\"></line>\r\n</svg>-->\r\n"
...
var LineComponent = /** @class */ (function () {
    ...
    LineComponent.prototype.show = function (id) {
        alert('inside line');
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, router, flashMessage, globals) {
        ...
        this.flashMessage = flashMessage;
        this.globals = globals;
        this.workflowName = (this.globals.workflowName === undefined) ? 'untitled workflow' : this.globals.workflowName;
    }
...
module.exports = "<div *ngIf=\"user\" class=\"profile\">\r\n  <h2 class=\"page-header\">{{name}}</h2>\r\n  <ul class=\"list-group\">\r\n    <li class=\"list-group-item\">Username: {{username}}</li>\r\n    <li class=\"list-group-item\">Email: {{email}}</li>\r\n  </ul>\r\n  <br>\r\n  <ul class=\"list-group\">\r\n    <li class=\"list-group-item\" *ngFor=\"let item of workflows\">\r\n      {{item.savedDate}} {{item.name}} <button class=\"btn btn-primary\" (click)=\"open(item)\">Open</button>\r\n    </li>\r\n  </ul>\r\n</div>\r\n"
